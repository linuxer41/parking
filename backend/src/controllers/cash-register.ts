...
import { CashRegisterSchema, CashRegister } from "../models/cash-register";


export const cashRegisterController = new Elysia({ prefix: '/cash-register', tags: ['cash-register'], detail: { summary: 'Obtener todos los cash-registers', description: 'Retorna una lista de todos los cash-registers registrados.', security: [{ branchId: [], token: [] }] } })
  .use(accessPlugin)
  ...
  .post('/', async ({ body }) => {
      ...
      detail: {
          ...
          description: 'Crea un nuevo registro de cash-register con los datos proporcionados.',
      },
      response: {
  ...
  .patch('/:id', async ({ params, body }) => {
      ...
      detail: {
          ...
          description: 'Actualiza un registro de cash-register existente con los datos proporcionados.',
      },
      response: {
          200: CashRegisterSchema,
          400: t.String(),
