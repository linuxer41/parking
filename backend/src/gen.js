...
const entities = {
  ...
  Level: {
    fields: {
      ...
      signages: { type: 'Signage', composite: true, description: 'Indicadores asociados al nivel', required: true, isArray: true },
      facilities: { type: 'Facility', composite: true, description: 'Oficinas asociadas al nivel', required: true, isArray: true },
      createdAt: { type: 'Date', composite: false, description: 'Fecha de creación del registro', required: true, isArray: false },
      updatedAt: { type: 'Date', composite: false, description: 'Fecha de última actualización del registro', required: true, isArray: false },
    },
    ...
    jsonSchemas: {
      SpotSchema: {
        fields: {
          ...
          posZ: { type: 'Number', composite: false, description: 'Coordenada Z del lugar', required: true, isArray: false },
          rotation: { type: 'Number', composite: false, description: 'Rotación del lugar', required: true, isArray: false },
          scale: { type: 'Number', composite: false, description: 'Escala del lugar', required: true, isArray: false },
          ...
          spotCategory: { type: 'Integer', composite: false, description: 'vip, normal, etc.', required: true, isArray: false },
        },
        createFields: ['name', 'posX', 'posY', 'vehicleId', 'spotType', 'spotCategory'],
        updateFields: ['name', 'posX', 'posY', 'vehicleId', 'spotType', 'spotCategory'],
      },
      SignageSchema: {
        fields: {
      ...
      FacilitySchema: {
        fields: {
          ...
          posZ: { type: 'Number', composite: false, description: 'Coordenada Z de la oficina', required: true, isArray: false },
          rotation: { type: 'Number', composite: false, description: 'Rotación de la oficina', required: true, isArray: false },
          scale: { type: 'Number', composite: false, description: 'Escala de la oficina', required: true, isArray: false },
          facilityType: { type: "Integer", composite: false, description: 'Tipo de oficina (oficina, oficina de entrada, etc.)', required: true, isArray: false },
        },
