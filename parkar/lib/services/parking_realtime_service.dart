...
class ParkingRealtimeService {
  static final ParkingRealtimeService _instance = ParkingRealtimeService._internal();
  ...
  Future<bool> updateSpotOccupancy(String spotId, bool isOccupied, String? vehiclePlate, String? vehicleColor) async {
    try {
      if (_state.currentLevel == null) return false;
      
      final uri = Uri.parse('$baseUrl/level/${_state.currentLevel!.id}/spot/$spotId/status');
