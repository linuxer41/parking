...
abstract class ParkingElement with ChangeNotifier {
  ...
  set selectionAnimationValue(double value) {
    if (_selectionAnimationValue != value) {
      ...
      ElementAnimation.setSelectionScale(id, 1.0 + (_selectionAnimationValue * 0.05));
  ...
  List<ParkingElement> _collidingWith = [];
  ...
  bool collidesWithElement(ParkingElement other) {
    ...
    final thisSize = this.getSize();
    final otherSize = other.getSize();
    
    final thisWidth = thisSize.width * this.scale;
    final thisHeight = thisSize.height * this.scale;
    ...
    final thisVertices = [
      _rotatePoint(-thisHalfWidth, -thisHalfHeight, this.rotation, this.position.x, this.position.y),
      _rotatePoint(thisHalfWidth, -thisHalfHeight, this.rotation, this.position.x, this.position.y),
      _rotatePoint(thisHalfWidth, thisHalfHeight, this.rotation, this.position.x, this.position.y),
      _rotatePoint(-thisHalfWidth, thisHalfHeight, this.rotation, this.position.x, this.position.y),
    ];
    ...
    final otherVertices = [
      _rotatePoint(-otherHalfWidth, -otherHalfHeight, other.rotation, other.position.x, other.position.y),
      _rotatePoint(otherHalfWidth, -otherHalfHeight, other.rotation, other.position.x, other.position.y),
      _rotatePoint(otherHalfWidth, otherHalfHeight, other.rotation, other.position.x, other.position.y),
      _rotatePoint(-otherHalfWidth, otherHalfHeight, other.rotation, other.position.x, other.position.y),
    ];
  ...
  Offset _rotatePoint(double x, double y, double angle, double centerX, double centerY) {
  ...
  vector_math.Vector2 getScreenPosition(double zoom, vector_math.Vector2 cameraPosition) {
  ...
  void drawIcon(Canvas canvas, IconData iconData, Size size, Color color, [double scale = 1.0]) {
